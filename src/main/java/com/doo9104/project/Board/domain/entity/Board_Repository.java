...
public interface Board_Repository extends JpaRepository<Board, Long> {
    ...
    List<Board> findAllByBoardtypeDesc(@Param("boardtype") Board.BoardType boardtype);

    Page<Board> findAllByBoardtype(Pageable pageable,Board.BoardType type);
    ...
    /* 검색 */
    Page<Board> findByTitleContainsAndBoardtype(Pageable pageable, String keyword,Board.BoardType type); // T
    Page<Board> findByContentContainsAndBoardtype(Pageable pageable, String keyword,Board.BoardType type); // C
    Page<Board> findByTitleContainsOrContentContainsAndBoardtype(Pageable pageable, String keyword1, String keyword2,Board.BoardType type);// TC
    Page<Board> findByWriterContainsAndBoardtype(Pageable pageable, String keyword,Board.BoardType type); // W
