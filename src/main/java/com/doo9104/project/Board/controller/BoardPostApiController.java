...
public class BoardPostApiController {
    ...
    public Long post(@RequestBody BoardDto boardDto,@PathVariable Board.BoardType type) {
    ...
    public Long update(@PathVariable Long id, @RequestBody BoardUpdateRequestDto boardUpdateRequestDto,@PathVariable Board.BoardType type) {
        return board_service.update(id, boardUpdateRequestDto);
    }

    // 글 삭제
    @DeleteMapping("{type}/post/{id}")
    public Long delete(@PathVariable Long id,@PathVariable Board.BoardType type) {
    ...
    public int toggleLike(@PathVariable Long id, @RequestBody User user,@PathVariable Board.BoardType type) {
